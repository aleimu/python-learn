#http://blog.csdn.net/thystar/article/category/3140461
SCREEN_SIZE = (640, 480)
NEST_POSITION = (320, 240)
ANT_COUNT = 20
NEST_SIZE = 100.
"""无数勤劳的小蚂蚁在整个地图上到处觅食，随机出现的叶子一旦被蚂蚁发现，就会搬回巢穴，而蜘蛛一旦出现在巢穴范围之内，就会被蚂蚁们群起而攻之，
直到被驱逐出地图范围或者挂了，蜘蛛的尸体也会被带入巢穴。
"""
import pygame
...
class World(object):
    ...
    def render(self, surface):
        ...
        for _,entity in [y for y in self.entities.items()]:
...
def run():
    ...
    leaf_image = pygame.image.load("./img/food_low.png").convert_alpha()
